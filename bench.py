...
minimal_attn = load(name='minimal_attn_v2_shared', sources=['main.cpp', 'flash_v2_Br64_Bc64.cu'], extra_cuda_cflags=['-O2'], verbose=True)
# minimal_attn = load(name='minimal_attn_v2_shared', sources=['main.cpp', 'flash_v2_Br128_Bc32.cu'], extra_cuda_cflags=['-O2'], verbose=True)
# minimal_attn = load(name='minimal_attn_v2_shared', sources=['main.cpp', 'flash_v2_Br128_Bc32_KVshared.cu'], extra_cuda_cflags=['-O2'], verbose=True)
